...
class Player:
    ...
    def _run_core(self, c: Controller):
        ...
        try:
            ...
            if map_area >= 1200:
                if rnd >= 250 and ti_late > 700 and self.target_economy_count < 2:
                    self.target_economy_count = 2
                if rnd >= 450 and ti_late > 1000 and self.target_economy_count < 3:
                    self.target_economy_count = 3
                if rnd >= 650 and ti_late > 1400 and self.target_economy_count < 4:
                    self.target_economy_count = 4
                if rnd >= 850 and ti_late > 1800 and self.target_economy_count < 5:
                    self.target_economy_count = 5
                if rnd >= 1050 and ti_late > 2400 and self.target_economy_count < 6:
                    self.target_economy_count = 6
                if rnd >= 1250 and ti_late > 3200 and self.target_economy_count < 7:
                    self.target_economy_count = 7
                if rnd >= 1450 and ti_late > 4200 and self.target_economy_count < 8:
