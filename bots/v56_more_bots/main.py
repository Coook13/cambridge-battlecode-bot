...
# ---- assault phase ----
# v56_more_bots: more bots per rush block to overwhelm xuanming's swarm
RUSH_START = 25              # was 30 — earlier rush
RUSH_BLOCK = 25              # was 30 — tighter cadence
RUSH_BOTS_PER_BLOCK = 18     # was 12 — 50% more bodies per wave
BONUS_MINERS_PER_BLOCK = 2   # was 1 — more miners per block
RESOURCE_GATE = 60           # was 80 — spawn even when Ti tighter
