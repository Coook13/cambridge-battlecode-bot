...
def _max_raiders_for_round(rnd: int) -> int:
    ...
    v13_pressure_sentinel: raise only the ceiling by +1. The existing
    Ti floor still paces actual spawns, but combat-active maps can keep
    more pressure once the economy is already paying for raiders.
    """
    if rnd < 200:
        return 2
    if rnd < 400:
