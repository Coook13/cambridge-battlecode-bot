...
# ---- economy phase ----
# v54_xuan_aggro: more aggressive constants to beat plain xuanming_v3.
WAVE_SIZE = 4
WAVE_INTERVAL = 120          # was 150 — faster waves
SCOUT_WAVE_SLOT = 1

# ---- assault phase ----
RUSH_START = 25              # was 30 — earlier rush
RUSH_BLOCK = 30
RUSH_BOTS_PER_BLOCK = 14     # was 12 — more bots per block
BONUS_MINERS_PER_BLOCK = 1
RESOURCE_GATE = 80

TURRET_PLANT_DIST2 = 25      # was 18 — plant turrets closer to enemy core
INFRA_DESTROY_DIST2 = 16     # was 10 — wider destruction radius
ROAM_DEMOLISH_START = 180    # was 220 — start demolishing earlier
