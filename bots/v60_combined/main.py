...
class Player:
    ...
    def _core(self, c):
        ...
        if round_num >= RUSH_START:
            ...
            # v57_more_stay: spawn 4 stay miners per block instead of 1
            # to harden home defense vs xuanming-style swarm attacks.
            bonus_target = (((round_num - RUSH_START) // RUSH_BLOCK) + 1) * 4
