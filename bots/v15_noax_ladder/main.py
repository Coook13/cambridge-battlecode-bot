...
def _max_raiders_for_round(rnd: int) -> int:
    ...
    v14_no1_ladder: one extra raider slot in each bracket. The Ti
    affordability floor still prevents early starvation, but combat-active
    maps can keep more pressure once the economy is paying for it.
    """
    if rnd < 200:
        return 2
    if rnd < 400:
