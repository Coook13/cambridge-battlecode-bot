...
class Player:
    ...
    def _run_core(self, c: Controller):
        ...
        try:
            ...
            if map_area >= 1200:
                if ti_late > 300 and self.target_economy_count < 4:
                    self.target_economy_count = 4
                if rnd >= 180 and ti_late > 700 and self.target_economy_count < 5:
                    self.target_economy_count = 5
                if rnd >= 360 and ti_late > 1100 and self.target_economy_count < 6:
                    self.target_economy_count = 6
                if rnd >= 600 and ti_late > 1600 and self.target_economy_count < 7:
                    self.target_economy_count = 7
                if rnd >= 900 and ti_late > 2300 and self.target_economy_count < 8:
                    self.target_economy_count = 8
            else:
